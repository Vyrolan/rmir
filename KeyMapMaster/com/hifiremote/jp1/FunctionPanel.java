...
//    table.setCellSelectionEnabled( true );
    ...
    JMenu submenu = new JMenu( "Auto resize mode" );
    popup.add( submenu );

    submenu.add( resizeAllColumns );
    submenu.add( resizeLastColumn );
    submenu.add( resizeNextColumn );
    submenu.add( resizeOff );
    submenu.add( resizeSubsequentCols );

    ButtonGroup group = new ButtonGroup();
    group.add( resizeAllColumns );
    group.add( resizeLastColumn );
    group.add( resizeNextColumn );
    group.add( resizeOff ); 
    group.add( resizeSubsequentCols );

    resizeAllColumns.addActionListener( this );
    resizeLastColumn.addActionListener( this );
    resizeNextColumn.addActionListener( this );
    resizeOff.addActionListener( this );
    resizeSubsequentCols.addActionListener( this );
  ...
  {
    if ( e.getSource() == resizeAllColumns )
      table.setAutoResizeMode( JTable.AUTO_RESIZE_ALL_COLUMNS );
    else if ( e.getSource() == resizeLastColumn )
      table.setAutoResizeMode( JTable.AUTO_RESIZE_LAST_COLUMN );
    else if ( e.getSource() == resizeNextColumn )
      table.setAutoResizeMode( JTable.AUTO_RESIZE_NEXT_COLUMN );
    else if ( e.getSource() == resizeOff )
      table.setAutoResizeMode( JTable.AUTO_RESIZE_OFF );
    else if ( e.getSource() == resizeSubsequentCols )
  ...
  private JRadioButtonMenuItem resizeAllColumns = new JRadioButtonMenuItem( "All columns" );
  private JRadioButtonMenuItem resizeLastColumn = new JRadioButtonMenuItem( "Last column" );
  private JRadioButtonMenuItem resizeNextColumn = new JRadioButtonMenuItem( "Next column" );
  private JRadioButtonMenuItem resizeOff        = new JRadioButtonMenuItem( "Off" );
  private JRadioButtonMenuItem resizeSubsequentCols = new JRadioButtonMenuItem( "Subsequest columns", true );
}
