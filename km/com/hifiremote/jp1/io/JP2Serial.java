 ...
 */
public class JP2Serial extends IO
{
   ...
   */
  public JP2Serial() throws UnsatisfiedLinkError
  {
    super( libraryName );
  }
   ...
   *           the unsatisfied link error
   */
  public JP2Serial( File folder ) throws UnsatisfiedLinkError
  {
  ...
  public static void main( String[] args )
  {
    ...
    {
      System.err.println( "No JP2 compatible remote found!" );
    }
  }

  private final static String libraryName = "jp2serial";
}
