...
public abstract class AdvancedCode
{
  ...
  public abstract int store( short[] buffer, int offset );
  ...
  protected static Format format = Format.HEX;
  protected static BindFormat bindFormat = BindFormat.NORMAL;

  public static void setFormat( Format format )
  {
    AdvancedCode.format = format;
  }
  ...
  public static void setBindFormat( BindFormat bindFormat )
  {
    AdvancedCode.bindFormat = bindFormat;
  }

  public static BindFormat getBindFormat()
  {
    return bindFormat;
  }
}
